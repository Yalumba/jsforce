...
Connection.prototype.loginBySoap = function(username, password, callback) {
  ...
  var logger = this._logger;
  var body = [
    '<se:Envelope xmlns:se="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:enterprise.soap.sforce.com">',
      '<se:Header>',
        '<urn:LoginScopeHeader>',
          '<urn:organizationId>00DN0000000B2g3</urn:organizationId>',
          '<urn:portalId>060N0000000D0g4</urn:portalId>',
        '</url:LoginScopeHeader>',
      '</se:Header>',
      '<se:Body>',
  ...
  var soapLoginEndpoint = this.loginUrl;
